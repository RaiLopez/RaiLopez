...
| :--: | ---------------------------- | ----------- | :---------------------------------------------: |
| [<picture><source media='(prefers-color-scheme: dark)' srcset='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls/assets/icon_dark.png'><img src='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls/assets/icon.png' width='48'></picture>](https://github.com/RaiLopez/ls/ 'Go to "ls" repo...') | [***LS&nbsp;<sup>Core</sup>***](https://github.com/RaiLopez/ls/ 'Go to "ls" repo...')  | ***<sup>Essential shared resources, utilities, and core modules required for the [Lost Scripts™](https://lost-scripts.github.io/) project to work with [MOHO](https://moho.lostmarble.com/)<sup>&nbsp;Pro</sup>.</sup>*** | [ &nbsp;⏬&nbsp; ](https://github.com/RaiLopez/ls/archive/refs/heads/main.zip 'Download: ls.zip') |
| [<picture><source media='(prefers-color-scheme: dark)' srcset='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls_shapes/assets/icon_dark.png'><img src='https://raw.githubusercontent.com/RaiLopez/RaiLopez/refs/heads/main/docs/ls_shapes/assets/icon.png' width='48'></picture>](https://github.com/RaiLopez/ls_shapes/ 'Go to "ls_shapes" repo...') | [<sup>**Shapes**</sup>](https://github.com/RaiLopez/ls_shapes/ 'Go to "ls_shapes" repo...')<br><sub><sup title='Build: 20260103-1852'>v0.4.2</sup></sub> | <sup>Persistent shape palette plus helpers for better Moho&reg; vector/s management.</sup><br><sub><sup>𝓲 For Moho 14.3+ Pro</sup></sub> | [ &nbsp;⏬&nbsp; ](https://github.com/RaiLopez/ls_shapes/archive/refs/heads/main.zip 'Download: ls_shapes.zip') |

<p align='right'><sub>𝓲 <em>Generated by <strong>Lost Builder</strong><sup> v1.6.2</sup> @ <code>20260402</code></em></sub></p>
<!-- CATALOG_END -->
</div>
