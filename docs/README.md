...
| :--: | ---------------------------- | ----------- | :---------------------------------------------: |
| [<img src='https://raw.githubusercontent.com/RaiLopez/ls/main/docs/README_icon.png' width='48'>](https://github.com/RaiLopez/ls/ 'Go to "ls" repo...') | [***LS&nbsp;<sup>Core</sup>***](https://github.com/RaiLopez/ls/ 'Go to "ls" repo...')  | ***<sup>Essential shared/common resources, utils, and core modules required by the [Lost Scripts™](https://lost-scripts.github.io/ "Go to Lost Scripts™ site...") project for [MOHO](https://moho.lostmarble.com/ "Go to Moho® homepage...")<sup> Pro</sup> Animation Software.</sup>*** | [ &nbsp;⏬&nbsp; ](https://github.com/RaiLopez/ls/archive/refs/heads/main.zip 'Download: ls.zip') |
| [<img src='https://raw.githubusercontent.com/RaiLopez/ls/main/docs/ls_shapes/index_icon.png' width='48'>](https://github.com/RaiLopez/ls_shapes/ 'Go to "ls_shapes" repo...') | [<sup>**Shapes**</sup>](https://github.com/RaiLopez/ls_shapes/ 'Go to "ls_shapes" repo...')<br><sub><sup title='Build: 20260103-1852'>v0.4.2</sup></sub> | <sup>Persistent shape palette plus helpers for better Moho&reg; vector/s management.</sup><br><sub><sup>𝓲 For Moho 14.3+ Pro</sup></sub> | [ &nbsp;⏬&nbsp; ](https://github.com/RaiLopez/ls_shapes/archive/refs/heads/main.zip 'Download: ls_shapes.zip') |
