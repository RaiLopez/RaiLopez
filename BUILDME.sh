...
| :--: | -- | -- | :--: |
| [<img src="${URL_RAW_CORE}/${CORE}@2x.png" width="48">](./${CORE}/ 'Go to \"$CORE\" (Core) repo...') | [***LS&nbsp;<sup>Core</sup>***](./${CORE}/ 'Go to \"$CORE\" (Core) repo...') | ***<sup>Essential shared/common resources, utils, and core modules required by [Lost Scripts™](https://lost-scripts.github.io/ "Go to Lost Scripts™ site...") project for Moho® <ins>Pro</ins>.</sup>*** | [ &nbsp;⏬&nbsp; ](${URL_BASE}/${CORE}/archive/refs/heads/main.zip 'Download: ${CORE}.zip') |
EOF
