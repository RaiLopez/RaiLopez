...
| :--: | ---------------------------- | ----------- | :---------------------------------------------: |
| [<img src='https://raw.githubusercontent.com/RaiLopez/ls/main/ScriptResources/ls/ls@2x.webp' width='48'>](#top) | [***LS&nbsp;<sup>Core</sup>***](#top 'Go to top...')  | ***<sup>Essential shared/common resources, utils, and core modules required by the [Lost Scripts™](https://lost-scripts.github.io/) project for MOHO<sup> Pro</sup> Animation Software.&nbsp;</sup>*** | [ &nbsp;⏬&nbsp; ](https://github.com/RaiLopez/ls/archive/refs/heads/main.zip 'Download: ls.zip') |
| [<img src='https://raw.githubusercontent.com/RaiLopez/ls/main/ScriptResources/ls/ls_fallback@2x.webp' width='48'>](https://github.com/RaiLopez/ls_shapes/) | [<sup>**Shapes**</sup>](https://github.com/RaiLopez/ls_shapes/ 'Go to "ls_shapes" repo...')<br><sub><sup title='Build: 20260103-1852'>v0.4.2</sup></sub> | <sup>Persistent shape palette plus helpers for better Moho&reg; vector/s management.</sup><br><sub><sup>ⓘ For Moho 14.3+ Pro</sup></sub> | [ &nbsp;⏬&nbsp; ](https://github.com/RaiLopez/ls_shapes/archive/refs/heads/main.zip 'Download: ls_shapes.zip') |
